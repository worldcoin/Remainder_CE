...
pub fn remainder_ligero_commit<F: Halo2FFTFriendlyField>(
...
pub fn remainder_ligero_eval_prove<F: Halo2FFTFriendlyField>(
...
///   `challenge_coord`.
pub fn remainder_ligero_verify<F: Halo2FFTFriendlyField>(
    commit_root: &F,
    aux: &LigeroAuxInfo<F>,
