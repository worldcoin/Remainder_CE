...
/// # Example:
/// ```
/// use frontend::zk_iriscode_ss::v3::circuit_description_and_inputs;
...
pub fn circuit_description_and_inputs(
    ...
    let image_bytes = if let Some(image_bytes) = image_bytes {
        ...
        let prover_root_dir = env!("CARGO_MANIFEST_DIR");
        let image_path =
            format!("{prover_root_dir}/src/zk_iriscode_ss/constants/v3-split-images/{image_type}/test_image.bin");
