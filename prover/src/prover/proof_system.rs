        ...
        paste::paste! {
            ...
            impl<F: Field> $crate::layer::LayerDescription<F> for [<$type_name DescriptionEnum>]<F> {
                ...
                fn verify_rounds(
                    ...
                    transcript: &mut impl $crate::shared_types::transcript::VerifierTranscript<F>,
                ...
                fn convert_into_verifier_layer(
                    ...
                    sumcheck_bindings: &[F],
                    claim_points: &[&[F]],
                    transcript_reader: &mut impl $crate::shared_types::transcript::VerifierTranscript<F>,
            ...
            impl<F: Field> $crate::layer::Layer<F> for [<$type_name Enum>]<F> {
                ...
                fn prove(
                    &mut self,
                    claims: &[&$crate::claims::RawClaim<F>],
                    transcript: &mut impl $crate::shared_types::transcript::ProverTranscript<F>,
                ) -> anyhow::Result<()> {
                    match self {
                        $(
