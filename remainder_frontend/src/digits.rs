...
/// # Example
/// ```
/// # use remainder_frontend::digits::unsigned_decomposition;
...
/// # Example:
/// ```
/// # use remainder_frontend::digits::complementary_decomposition;
...
/// use remainder_frontend::digits::digits_to_field;
...
/// ```
/// use remainder_shared_types::Fr;
/// use remainder_frontend::digits::to_slice_of_mles;
/// let inputs = vec![
