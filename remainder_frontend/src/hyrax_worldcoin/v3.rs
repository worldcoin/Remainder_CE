#![allow(warnings)]
<<<<<<< HEAD:remainder_hyrax/src/hyrax_worldcoin/v3.rs
...
use crate::hyrax_gkr::{self, verify_hyrax_proof, HyraxProof};
...
>>>>>>> benny/abstract_expr:remainder_frontend/src/hyrax_worldcoin/v3.rs
use clap::error;
...
<<<<<<< HEAD:remainder_hyrax/src/hyrax_worldcoin/v3.rs
use remainder::zk_iriscode_ss::circuits::input_builder;
use remainder::zk_iriscode_ss::circuits::{InputBuilderMetadata, IriscodeCircuitDescription};
use remainder::zk_iriscode_ss::parameters::IRISCODE_COMMIT_LOG_NUM_COLS;
use remainder::zk_iriscode_ss::v3::{circuit_description_and_inputs, load_worldcoin_data};
=======
>>>>>>> benny/abstract_expr:remainder_frontend/src/hyrax_worldcoin/v3.rs
