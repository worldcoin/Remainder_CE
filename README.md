...
## Status
Parts of _Remainder_ have been audited in the past, although we currently provide **no official guarantees** on the security of the current implementation. Past audits can be found in our [`audit_reports/`](./audit_reports/) directory. 
