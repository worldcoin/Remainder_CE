...
* Interpolative claim aggregation from [Tha13](https://ia.cr/2013/351) and random linear combination claim aggregation from [XZZ+19](https://eprint.iacr.org/2019/317)
...
## Documentation
_Remainder_ comes with two primary official documentation resources:
* The highly-recommended [_Remainder_ book](https://worldcoin.github.io/remainder-documentation/), which offers an intuitive introduction to GKR and Hyrax, and dives into both the GKR/Hyrax theory and concrete examples of how to use various circuit layer types in circuit-building. 
* Our autogenerated [Rust docs](http://worldcoin.github.io/remainder_ce), which provide code-level detail on specific functions and structs. 

## Status
Parts of _Remainder_ have been audited in the past, although we currently provide **no official guarantees** on the security of the current implementation. Past audits can be found in our [`audit_reports/`](./audit_reports/) directory. The code in this repository is not currently deployed in production and does not qualify for our bug bounty program. 
