...
mod tests {
    ...
    fn circuit_dummy_bits_are_binary_test_diff() {
        ...
        // --- Do b * (1 - b) = b - b^2 ---
        let b_squared = Expression::Product(vec![
    ...
    fn circuit_dummy_bits_are_binary_test_multiplicities() {
        ...
        let _all_zeros_mle_expr = Expression::<Fr, ProverExpression>::Mle(all_zeros_mle.mle_ref());
    ...
    fn circuit_dummy_binary_recomp_test() {
        ...
        let b_s_times_abs_recomp_expr = bin_decomp_mles.into_iter().enumerate().skip(1).fold(
            ...
            |acc_expr, (bit_idx, bin_decomp_mle)| {
                ...
                let b_s_times_coeff =
                    Expression::Product(vec![bin_decomp_mle, sign_bit_mle.clone()]);
    ...
    fn dummy_permutation_test() {
        ...
        let _dummy_attribute_id_mleref_expr = Expression::<Fr, ProverExpression>::Mle(dummy_attribute_id_mleref);
        let dummy_attribute_val_mleref = dummy_input_data_mle.attr_val(None);
        let _dummy_attribute_val_mleref_expr = Expression::<Fr, ProverExpression>::Mle(dummy_attribute_val_mleref);
