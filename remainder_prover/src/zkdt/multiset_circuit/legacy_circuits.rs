...
use super::super::{
    builders::{
        DecisionPackingBuilder, EqualityCheck, LeafPackingBuilder, ProductBuilder, RMinusXBuilder,
...
impl<F: FieldExt> GKRCircuit<F> for MultiSetCircuit<F> {
    ...
    fn synthesize(&mut self) -> Witness<F, Self::Transcript> {
        ...
        let decision_packing_builder =
            DecisionPackingBuilder::new(dummy_decision_nodes_mle, self.r, self.r_packings);
        ...
        let leaf_packing_builder =
            LeafPackingBuilder::new(dummy_leaf_nodes_mle, self.r, self.r_packings.0);
        ...
        let mut dummy_multiplicities_bin_decomp_mle_decision =
            self.multiplicities_bin_decomp_mle_decision.clone();
        dummy_multiplicities_bin_decomp_mle_decision.set_prefix_bits(
        ...
        let mut dummy_multiplicities_bin_decomp_mle_leaf =
        ...
        let decision_path_packing_builder = BatchedLayer::new(
            self.decision_node_paths_mle_vec
                ...
                .map(|decision_node_mle| {
                    ...
                    DecisionPackingBuilder::new(decision_node_mle.clone(), self.r, self.r_packings)
                })
                .collect_vec(),
        );
        ...
        let leaf_path_packing_builder = BatchedLayer::new(
            self.leaf_node_paths_mle_vec
                ...
                .map(|leaf_node_mle| {
                    ...
                    LeafPackingBuilder::new(leaf_node_mle.clone(), self.r, self.r_packings.0)
                })
                .collect_vec(),
        );
