...
use crate::{
    claims::{
        ...
        ClaimError, ProverYieldClaim, VerifierYieldClaim,
    },
    expression::{
...
impl<F: FieldExt> ProverYieldClaim<F, ClaimMle<F>> for RegularLayer<F> {
    fn get_claims(
        &self,
             ...
             mle_vec: &<ProverExpr as ExpressionType<F>>::MleVec| {
                match exp {
                    ExpressionNode::Mle(mle_vec_idx) => {
                        ...
                        // Append claim result to transcript.
                        transcript_writer.append("MLE leaf claim result", claimed_value);
                    ...
                    ExpressionNode::Product(mle_vec_indices) => {
                        for mle_vec_index in mle_vec_indices {
                            ...
                            // Append claim result to the transcript.
                            transcript_writer
                                .append("Product leaf MLE claim result", claimed_value);
...
impl<F: FieldExt> VerifierYieldClaim<F, ClaimMle<F>> for VerifierRegularLayer<F> {
    fn get_claims(
        &self,
