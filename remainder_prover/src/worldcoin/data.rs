...
mod test {
    ...
    use crate::{
        mle::{circuit_mle::CircuitMle, Mle}, utils::mle::pad_with, worldcoin::parameters_v2::{CONSTANT_DATA_FOLDER}};
    use crate::worldcoin::parameters_v2::{BASE, NUM_DIGITS};
    ...
    fn test_circuit_data_creation_v2_iris_and_mask() {
        ...
        for is_mask in vec![false, true] {
            ...
            let data: WorldcoinCircuitData<Fr, BASE, NUM_DIGITS> = load_data(path.clone(), image_path, is_mask);
