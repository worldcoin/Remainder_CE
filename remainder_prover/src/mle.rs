...
use crate::{claims::RawClaim, layer::LayerId, mle::mle_bookkeeping_table::MleBookkeepingTables};
...
/// Defines a bookkeeping table to perform operations on [Mle]
pub mod mle_bookkeeping_table;

/// Defines ways to combine bookkeeping tables
pub mod mle_combination;
...
pub trait Mle<F: Field>: Clone + Debug + Send + Sync {
    ...
    /// convert the MLE to a bookkeeping tbale
