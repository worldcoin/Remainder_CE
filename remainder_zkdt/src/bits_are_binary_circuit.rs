...
impl<F: FieldExt> BitsAreBinary16BitComponent<F> {
    pub fn new(ctx: &Context, bin_decomp_16_bit: impl CircuitNode) -> Self {
        let bin_decomp_16_bit_is_binary_sector =
            Sector::new(ctx, &[&bin_decomp_16_bit], |signed_bin_decomp_mle| {
