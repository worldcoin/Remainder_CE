...
use crate::builders::{AttributeConsistencyBuilderZeroRef, BitExponentiationBuilderCatBoost};
...
mod tests {
    ...
    use crate::cache_upshot_catboost_inputs_for_testing::generate_mles_batch_catboost_single_tree;
