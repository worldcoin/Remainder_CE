...
mod tests {
    ...
    use super::super::hyrax_input_layer::HyraxInputLayer;
    use super::super::hyrax_layer::HyraxLayerProof;
    ...
    fn selector_only_test() {
        ...
        let selector_circuit_expression =
            circuit_expression_right.concat_expr(circuit_expression_left);
        ...
        // Construct the GKR Layer from the expression
        let layer: RegularLayer<Scalar> =
            RegularLayer::new_raw(LayerId::Layer(0), selector_expression);
        let mut layer_enum = LayerEnum::Regular(Box::new(layer));
        let mut circuit_layer_enum = CircuitLayerEnum::Regular(CircuitRegularLayer::new_raw(
            LayerId::Layer(0),
    ...
    fn small_regular_circuit_hyrax_input_layer_test() {
        ...
        let mut circuit_function: &mut dyn FnMut(
            ...
            let input_shred_data =
                InputShredData::new(input_shred.id(), input_multilinear_extension);
